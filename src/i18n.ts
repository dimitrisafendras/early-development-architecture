...
const en = {
  nav: {
    ...
    dayLayoutSide: 'Schedule beside the moment',
    dayLayoutTop: 'Schedule across the top',
    boy: 'Boy',
    girl: 'Girl',
    theme: 'Color theme',
  ...
  schedule: {
    ...
    factGuidance: 'Guidance',
    factNext: 'Next change',
    ...
    // "This day plans …" was the old prefix; the row's own label now says that,
    // so the value states only the two numbers being compared.
    activityValue: '{planned} min of {kind} — the guidance at this age is {target} min',
  ...
  sleepLog: {
    title: 'Sleep Log',
    subtitle: 'Start a sleep when they go down and stop it when they wake — or log a finished one with both times.',
    add: 'Log a sleep',
    start: 'Start sleep',
    stop: 'They woke up',
    running: 'Asleep now',
    startedAt: 'Down at {time}',
    startLabel: 'Fell asleep',
    endLabel: 'Woke up',
    noteLabel: 'Note (optional)',
    save: 'Log sleep',
    delete: 'Delete sleep',
    todayTitle: "Today's sleeps",
    historyTitle: 'Recent sleeps',
    none: 'No sleep logged today yet.',
    noHistory: 'No sleep logged yet.',
    totalToday: 'Slept today',
    countToday: 'Sleeps today',
    longestToday: 'Longest stretch',
    sinceLast: 'Awake for',
    never: '—',
    /** Derived from the clock, never stored — see the sleep log page. */
    night: 'Night',
    nap: 'Nap',
    localOnly: 'Saved on this device. Sign in to sync.',
    synced: 'Syncing to your account.',
    targetTitle: 'Today vs typical',
    /** {range} is e.g. "14–17" — the AASM/AAP band for the age. */
    target: 'Typical at this age: {range} h per 24 h, naps included.',
    targetNote: 'A range, not a target — children vary by hours.',
    belowRange: 'Below the typical range so far today.',
    inRange: 'Within the typical range for the age.',
    aboveRange: 'Above the typical range — worth a mention at the next check-up.',
    endBeforeStart: 'The wake time must be after they fell asleep.',
    endInFuture: 'That is in the future.',
    weekTitle: 'Sleep this week',
    weekSeries: 'Hours slept',
  },
  routineLive: {
    nowBadge: 'NOW',
    rightNow: 'Right now',
  ...
  tracker: {
    ...
    toGo: 'min to go',
    planned: 'Day plans {mins} min',
    ofPlanned: 'of {n} sessions planned',
    lastSessionAt: 'last at {time}',
    targetMet: 'Daily target met! 🎉',
    planMet: 'Day plan complete! 🎉',
    planLabel: 'Day plan',
...
const el: Messages = {
  nav: {
    ...
    dayLayout: 'Διάταξη ημέρας',
    dayLayoutSide: 'Πρόγραμμα δίπλα στη στιγμή',
    dayLayoutTop: 'Πρόγραμμα στην κορυφή',
    boy: 'Αγόρι',
    girl: 'Κορίτσι',
    theme: 'Θέμα χρωμάτων',
  ...
  schedule: {
    ...
    factGuidance: 'Σύσταση',
    factNext: 'Επόμενη αλλαγή',
    nextChangeLabel: 'Επόμενη αλλαγή στους {age}',
    nextChangeAt: 'Σε ηλικία {age}',
    ...
    activityValue: '{planned} λεπτά «{kind}» — η σύσταση για αυτή την ηλικία είναι {target} λεπτά',
  ...
  sleepLog: {
    ...
    subtitle: 'Ξεκινήστε τον ύπνο όταν κοιμηθεί και σταματήστε τον όταν ξυπνήσει — ή καταγράψτε έναν ολοκληρωμένο με τις δύο ώρες.',
    add: 'Καταγραφή ύπνου',
    start: 'Έναρξη ύπνου',
    stop: 'Ξύπνησε',
    running: 'Κοιμάται τώρα',
    startedAt: 'Κοιμήθηκε στις {time}',
    startLabel: 'Κοιμήθηκε',
    endLabel: 'Ξύπνησε',
    noteLabel: 'Σημείωση (προαιρετικό)',
    save: 'Καταγραφή ύπνου',
    delete: 'Διαγραφή ύπνου',
    todayTitle: 'Ο ύπνος σήμερα',
    historyTitle: 'Πρόσφατοι ύπνοι',
    none: 'Δεν έχει καταγραφεί ύπνος σήμερα.',
    noHistory: 'Δεν έχει καταγραφεί ύπνος ακόμη.',
    totalToday: 'Ύπνος σήμερα',
    countToday: 'Ύπνοι σήμερα',
    longestToday: 'Μεγαλύτερο διάστημα',
    sinceLast: 'Ξύπνιο για',
    never: '—',
    night: 'Νύχτα',
    nap: 'Υπνάκος',
    localOnly: 'Αποθηκεύτηκε σε αυτή τη συσκευή. Συνδεθείτε για συγχρονισμό.',
    synced: 'Συγχρονισμός στον λογαριασμό σας.',
    targetTitle: 'Σήμερα vs τυπικό',
    target: 'Τυπικό σε αυτή την ηλικία: {range} ώ. ανά 24ω, μαζί με τους υπνάκους.',
    targetNote: 'Εύρος, όχι στόχος — τα παιδιά διαφέρουν κατά ώρες.',
    belowRange: 'Κάτω από το τυπικό εύρος μέχρι στιγμής σήμερα.',
    inRange: 'Εντός του τυπικού εύρους για την ηλικία.',
    aboveRange: 'Πάνω από το τυπικό εύρος — αξίζει αναφορά στον επόμενο έλεγχο.',
    endBeforeStart: 'Η ώρα αφύπνισης πρέπει να είναι μετά την ώρα που κοιμήθηκε.',
    endInFuture: 'Αυτό είναι στο μέλλον.',
    weekTitle: 'Ύπνος αυτή την εβδομάδα',
    weekSeries: 'Ώρες ύπνου',
  },
  routineLive: {
    nowBadge: 'ΤΩΡΑ',
  ...
  tracker: {
    ...
    toGo: 'λεπτά ακόμη',
    planned: 'Η μέρα προβλέπει {mins} λεπτά',
    ofPlanned: 'από {n} προγραμματισμένες',
    lastSessionAt: 'τελευταία στις {time}',
    targetMet: 'Ο ημερήσιος στόχος επιτεύχθηκε! 🎉',
    planMet: 'Ολοκληρώθηκε το πλάνο της μέρας! 🎉',
    planLabel: 'Πλάνο μέρας',
