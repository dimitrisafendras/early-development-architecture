...
const en = {
  ...
  schedule: {
    ...
    blueprintsHint: 'The nine sample days, birth to three. Load one to start from it.',
...
const el: Messages = {
  ...
  schedule: {
    ...
    blueprintsHint: 'Οι εννέα ενδεικτικές μέρες, από τη γέννηση ως τα τρία. Φορτώστε μία για αφετηρία.',
