...
const en = {
  ...
  bathing: {
    ...
    facts: [
      ...
      { value: '≤37°C', label: 'Warm, never hot', note: 'Test on your wrist; set the water heater no higher than 49°C / 120°F.' },
      { value: '~5cm', label: 'Shallow water', note: 'About 2 inches — and never step away, not even for a moment.' },
    ],
    ...
    practices: [
      ...
      { title: 'Then a shallow tub', text: 'Once the cord area has healed, move to a small basin with ~2 inches of warm water; support the head and neck the whole time.' },
    ...
    safety: [
      ...
      { title: 'Check the temperature', text: 'Warm, not hot, to your wrist or elbow. Cap the water heater at 49°C / 120°F to prevent scald burns.' },
      { title: 'Keep water shallow', text: 'About 2 inches (5 cm). A baby can drown in a very small amount of water.' },
...
const el: Messages = {
  ...
  bathing: {
    ...
    facts: [
      ...
      { value: '≤37°C', label: 'Ζεστό, ποτέ καυτό', note: 'Δοκιμάστε στον καρπό· ρυθμίστε τον θερμοσίφωνα το πολύ στους 49°C / 120°F.' },
      { value: '~5εκ', label: 'Ρηχό νερό', note: 'Περίπου 5 εκ. — και μη φεύγετε ποτέ, ούτε στιγμή.' },
    ],
    ...
    safety: [
      ...
      { title: 'Ελέγξτε τη θερμοκρασία', text: 'Ζεστό, όχι καυτό, στον καρπό ή τον αγκώνα. Ρυθμίστε τον θερμοσίφωνα στους 49°C / 120°F για αποφυγή εγκαυμάτων.' },
