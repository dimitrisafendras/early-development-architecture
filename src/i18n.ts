...
const en = {
  ...
  daily: {
    ...
    restTitle: 'Rest & bonding',
    restText: 'Calm time — dim the lights, slow your voice, and follow your baby’s cues. Nothing to track right now.',
...
const el: Messages = {
  ...
  daily: {
    ...
    restTitle: 'Ξεκούραση & δέσιμο',
    restText: 'Ώρα ηρεμίας — χαμηλώστε τα φώτα, μιλήστε αργά και ακολουθήστε τα σήματα του μωρού. Τίποτα προς καταγραφή τώρα.',
