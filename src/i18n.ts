...
const en = {
  ...
  schedule: {
    ...
    programsEmpty: 'No programs yet. Start from the five sample days, or build one from scratch.',
    ...
    bandSeedAll: 'Create all five (0–3 years)',
    bandRemove: 'Delete this day',
    blueprintsTitle: 'Day blueprints',
    blueprintsHint: 'The five sample days, birth to three. Load one to start from it.',
    blueprintCurrent: 'Matches your baby',
    blueprintSlots: '{n} moments',
    blueprintUse: 'Load this day',
    blueprintConfirm: 'Replace the moments below with this sample day?',
    presetsTitle: 'Add from your day',
  ...
  fullDay: {
    ...
    note: "Newborns (0–3 mo) won't hold a fixed clock yet — feed on demand and follow sleepy cues. A recognisable pattern usually emerges around 3–4 months, the two-nap day around 6–12 months, one nap between 13 and 18 months, and by three a third of children have dropped the nap for quiet time.",
    lengthNote:
      'Each length is the typical middle of the published range for the age, not a stopwatch target: milk feeds 20–30 min (night feeds stay short on purpose), meals 15–35 min, naps 30 min–2 h, tummy time 5–10 min a session under six months, and active play adding up to the 180 min a day the WHO asks for from the first birthday. Total sleep lands inside the AASM bands — 14–17 h at 0–3 mo, 12–16 h at 4–12 mo, 11–14 h at 1–2 y, 10–13 h at 3 y. Your child will run shorter or longer — end an activity when they tell you to, not when the clock does.',
    days: {
    newborn: [
      { title: 'Wake & feed', detail: 'Feed on waking, whenever that is — 8–12 feeds a day at this age, on demand.' },
      { title: 'Nappy & dress', detail: 'Narrate each step; slow, warm parentese from the very first weeks.' },
      { title: 'Face-to-face', detail: 'Hold them ~20–30 cm away and let them study your face. Copy any sound they make.' },
      { title: 'Tummy time', detail: '2–3 min on your chest or a firm mat, awake and watched — start the day you come home.' },
      { title: 'Morning sleep', detail: 'A newborn is awake 45–60 min at most. Settle at the first yawn or gaze away.' },
      { title: 'Feed', detail: 'Every 2–3 h through the day; wake them to feed if a stretch runs past 3–4 h early on.' },
      { title: 'Quiet play', detail: 'A slow-moving high-contrast card, a song, your voice. Minutes, not half-hours.' },
      { title: 'Sleep', detail: 'Cot or bassinet, on the back, in your room. Day sleep can stay light and short.' },
      { title: 'Feed', detail: 'Midday feed; check the nappy and switch sides if you are nursing.' },
      { title: 'Tummy time', detail: 'Second short session while they are content — never after a big feed.' },
      { title: 'Cuddle & chat', detail: 'Skin-to-skin, rocking, humming. Regulation is the developmental task right now.' },
      { title: 'Long day sleep', detail: 'Often the longest of the day. Keep the room calm; nappy change only if needed.' },
      { title: 'Feed', detail: 'Afternoon feed. Cluster feeding late in the day is normal, not a supply problem.' },
      { title: 'Awake & held', detail: 'Carry them, walk the room, name what you see — the evening fussy hour starts here.' },
      { title: 'Catnap', detail: 'A short bridge to the evening; in a carrier or pram is fine.' },
      { title: 'Feed', detail: 'Early-evening feed, often the fussiest of the day. Dim the lights.' },
      { title: 'Bath or top-and-tail', detail: 'A full bath 2–3 times a week is plenty; warm, brief, predictable.' },
      { title: 'Wind-down', detail: 'Lights low, voices low, no screens in the room. Same order every night.' },
      { title: 'Bedtime feed', detail: 'Full feed to settle for the longest stretch they can manage.' },
      { title: 'Night sleep begins', detail: 'On the back, firm flat surface, own sleep space, room-sharing with you.' },
      { title: 'Night feed', detail: 'Feed on waking; keep it dark, quiet and boring — no play, minimal talk.' },
      { title: 'Night feed', detail: 'Nappy only if soiled or soaked; straight back down afterwards.' },
      { title: 'Early-hours feed', detail: 'The last night feed before morning. Newborns need 1–3 of these.' },
    ],
    infant: [
    ...
    older: [
      { title: 'Wake & milk', detail: 'Milk first on waking — still 4–5 milk feeds a day beside the solids.' },
      { title: 'Breakfast', detail: 'Iron-rich solids: porridge, egg, soft fruit. Let them feed themselves and make a mess.' },
      { title: 'Nappy & dress', detail: 'Narrate it, name body parts, wait for the sound they give back.' },
      { title: 'Floor play', detail: 'Everything on the floor now: rolling, sitting, reaching, pulling to stand.' },
      { title: 'Crawling & tummy work', detail: 'Tunnels, cushions, a toy just out of reach. Movement is the whole curriculum.' },
      { title: 'Morning nap', detail: 'Still 2–3 naps; the morning one is usually short (~45–60 min).' },
      { title: 'Milk', detail: 'Milk on waking, then straight into play — solids are the meals, milk is the drink.' },
      { title: 'Books & babble', detail: 'Board books they can grab, point at pictures, answer their babble like words.' },
      { title: 'Lunch', detail: 'Family food, soft finger foods, water in an open or straw cup. No honey before one.' },
      { title: 'Midday nap', detail: 'The long one — 1h30 or so. Dark room, same routine as the night, in the cot.' },
      { title: 'Milk', detail: 'Afternoon milk, then out. Drop this feed when they start refusing it.' },
      { title: 'Outing & exploring', detail: 'Park, buggy-free floor time, sand, grass, other children to watch.' },
      { title: 'Catnap', detail: 'A short third nap that usually disappears somewhere around 8–9 months.' },
      { title: 'Snack', detail: 'Small solid snack, sitting down, never in the buggy on the move.' },
      { title: 'Active play', detail: 'Pull-to-stand, cruising the furniture, stacking and knocking down.' },
      { title: 'Dinner', detail: 'Eat together if you can — they learn to eat by watching you eat.' },
      { title: 'Bath & teeth', detail: 'Brush the first teeth with a smear of fluoride paste from the day they appear.' },
      { title: 'Wind-down', detail: 'Two or three books, lights down, same order every night.' },
      { title: 'Bedtime milk', detail: 'Last milk of the day — then teeth, then bed, not milk in bed.' },
      { title: 'Night sleep', detail: 'On the back until one, own cot, ~11 h. Many babies drop night feeds in this band.' },
    ],
    oneNap: [
      { title: 'Wake & breakfast', detail: 'Straight to the table. Whole cow’s milk in an open cup from one, ~470–710 ml a day total.' },
      { title: 'Dress & teeth', detail: 'Let them try, then finish the job. Brush twice a day, you do the second one.' },
      { title: 'Active play', detail: 'Walking, climbing, pushing, carrying. Aim for 180 min of movement across the day.' },
      { title: 'Morning snack', detail: 'Sitting down, water alongside. Two snacks and three meals is the shape of the day now.' },
      { title: 'Outside', detail: 'Park, garden, walking rather than being pushed — never restrained over an hour at a time.' },
      { title: 'Lunch', detail: 'Same food as you, cut safely. Offer, don’t push; appetite swings wildly at this age.' },
      { title: 'One nap', detail: 'The 2-to-1 switch usually lands at 13–18 months. Aim for 1.5–2 h after lunch.' },
      { title: 'Afternoon snack', detail: 'Milk or water plus something solid; keep an eye on total milk so it doesn’t crowd out food.' },
      { title: 'Active play', detail: 'Balls, ride-ons, stairs with a hand, pretend play starting to appear.' },
      { title: 'Books & quiet play', detail: 'Read every day; name feelings out loud — this is where tantrums start and language helps.' },
      { title: 'Dinner', detail: 'Family table, no screens at the table, they see you eating the same thing.' },
      { title: 'Bath & teeth', detail: 'Bath, then teeth, then the last drink — nothing sugary after brushing.' },
      { title: 'Wind-down', detail: 'Books and songs, no screens in the hour before bed. Same three steps, same order.' },
      { title: 'Night sleep', detail: '~11–11.5 h. Total sleep including the nap should land in the 11–14 h band.' },
    ],
    toddler: [
      { title: 'Wake & breakfast', detail: 'Up around seven. Milk in a cup at the table, not a bottle in bed.' },
      { title: 'Dress & teeth', detail: 'Offer two choices so they get some control; you still supervise the brushing.' },
      { title: 'Active play', detail: 'Running, jumping, climbing. 180 min of activity a day, at least 60 of it energetic.' },
      { title: 'Snack', detail: 'A small sit-down snack; water between meals rather than juice.' },
      { title: 'Outside & gross motor', detail: 'Playground, scooter, ball games, other children — the social skills come from this.' },
      { title: 'Lunch', detail: 'Family food, family table. Serve small, let them ask for more.' },
      { title: 'Nap or quiet time', detail: 'About a third of three-year-olds have dropped the nap. If they have, keep an hour of quiet time in its place.' },
      { title: 'Snack', detail: 'Something solid and a drink; they will be hungrier on a no-nap day.' },
      { title: 'Pretend & active play', detail: 'Role play, blocks, drawing, back-and-forth conversation of two or more turns.' },
      { title: 'Helping & tidy-up', detail: 'Sorting laundry, watering plants, putting toys away with you — real jobs, done together.' },
      { title: 'Dinner', detail: 'Eat together, talk about the day, keep screens off the table.' },
      { title: 'Bath & teeth', detail: 'Bath, teeth, toilet. A predictable order is what makes bedtime negotiable.' },
      { title: 'Wind-down', detail: 'Books, songs, no screens in the last hour. Any screen time earlier: max 1 h, watched with you.' },
      { title: 'Night sleep', detail: '~11 h in bed. Total sleep 10–13 h at this age, nap included if they still take one.' },
    ],
    },
    sourcesLabel:
...
const el: Messages = {
  ...
  schedule: {
    ...
    titleLabel: 'Τίτλος',
    whatLabel: 'Τι',
    dragHint: 'Σύρετε για αναδιάταξη',
    ...
    bandSeedAll: 'Δημιουργία και των πέντε (0–3 ετών)',
    bandRemove: 'Διαγραφή αυτής της μέρας',
    blueprintsTitle: 'Πρότυπα ημέρας',
    blueprintsHint: 'Οι πέντε ενδεικτικές μέρες, από τη γέννηση ως τα τρία. Φορτώστε μία για αφετηρία.',
    blueprintCurrent: 'Ταιριάζει στο μωρό σας',
    ...
    presetsTitle: 'Προσθήκη από τη μέρα σας',
  ...
  fullDay: {
    ...
    note: 'Τα νεογνά (0–3 μην.) δεν κρατούν σταθερό ρολόι ακόμη — ταΐστε όποτε το ζητά και ακολουθήστε τα σημάδια ύπνου. Ένα αναγνωρίσιμο μοτίβο εμφανίζεται γύρω στους 3–4 μήνες, η μέρα με δύο υπνάκους στους 6–12 μήνες, ο ένας υπνάκος μεταξύ 13 και 18 μηνών, και στα τρία περίπου ένα τρίτο των παιδιών έχει κόψει τον υπνάκο και κρατά ήσυχη ώρα στη θέση του.',
    lengthNote:
      'Κάθε διάρκεια είναι το τυπικό μέσο του δημοσιευμένου εύρους για την ηλικία, όχι στόχος χρονομέτρου: γάλα 20–30 λεπτά (τα νυχτερινά μένουν σύντομα επίτηδες), γεύματα 15–35 λεπτά, ύπνοι 30 λεπτά–2 ώρες, μπρούμυτα 5–10 λεπτά ανά συνεδρία κάτω των έξι μηνών, και ενεργό παιχνίδι που αθροίζει τα 180 λεπτά την ημέρα που ζητά ο ΠΟΥ από τα πρώτα γενέθλια. Ο συνολικός ύπνος πέφτει μέσα στα εύρη AASM — 14–17 ώρες στους 0–3 μήνες, 12–16 στους 4–12, 11–14 στα 1–2 έτη, 10–13 στα 3. Το δικό σας παιδί θα πάει πιο σύντομα ή πιο μακριά — τελειώστε μια δραστηριότητα όταν το λέει εκείνο, όχι το ρολόι.',
    days: {
    newborn: [
      { title: 'Ξύπνημα & τάισμα', detail: 'Τάισμα στο ξύπνημα, όποτε γίνει — 8–12 ταΐσματα τη μέρα, κατά ζήτηση.' },
      { title: 'Αλλαγή & ντύσιμο', detail: 'Περιγράψτε κάθε βήμα· αργή, ζεστή παιδική ομιλία από τις πρώτες εβδομάδες.' },
      { title: 'Πρόσωπο με πρόσωπο', detail: 'Κρατήστε το ~20–30 εκ. μακριά και αφήστε το να μελετήσει το πρόσωπό σας. Μιμηθείτε κάθε ήχο του.' },
      { title: 'Χρόνος μπρούμυτα', detail: '2–3 λεπτά στο στήθος σας ή σε σταθερό στρωματάκι, ξύπνιο και υπό επίβλεψη — από την πρώτη μέρα στο σπίτι.' },
      { title: 'Πρωινός ύπνος', detail: 'Το νεογνό μένει ξύπνιο 45–60 λεπτά το πολύ. Κοιμίστε το στο πρώτο χασμουρητό.' },
      { title: 'Τάισμα', detail: 'Κάθε 2–3 ώρες μέσα στη μέρα· ξυπνήστε το αν περάσουν 3–4 ώρες τις πρώτες εβδομάδες.' },
      { title: 'Ήσυχο παιχνίδι', detail: 'Μια κάρτα υψηλής αντίθεσης που κινείται αργά, ένα τραγούδι, η φωνή σας. Λεπτά, όχι μισάωρα.' },
      { title: 'Ύπνος', detail: 'Κούνια ή πορτ-μπεβέ, ανάσκελα, στο δωμάτιό σας. Ο ημερήσιος ύπνος μένει ελαφρύς και σύντομος.' },
      { title: 'Τάισμα', detail: 'Μεσημεριανό τάισμα· έλεγχος πάνας και αλλαγή πλευράς στον θηλασμό.' },
      { title: 'Χρόνος μπρούμυτα', detail: 'Δεύτερη σύντομη συνεδρία όσο είναι ευχαριστημένο — ποτέ μετά από μεγάλο τάισμα.' },
      { title: 'Αγκαλιά & κουβέντα', detail: 'Δέρμα με δέρμα, κούνημα, σιγανό τραγούδι. Η ρύθμιση είναι το αναπτυξιακό έργο τώρα.' },
      { title: 'Μεγάλος ύπνος', detail: 'Συχνά ο μεγαλύτερος της μέρας. Κρατήστε το δωμάτιο ήρεμο· αλλαγή μόνο αν χρειάζεται.' },
      { title: 'Τάισμα', detail: 'Απογευματινό τάισμα. Τα πυκνά ταΐσματα προς το βράδυ είναι φυσιολογικά, όχι πρόβλημα γάλακτος.' },
      { title: 'Ξύπνιο στην αγκαλιά', detail: 'Κρατήστε το, περπατήστε, ονομάστε ό,τι βλέπετε — εδώ ξεκινά η βραδινή γκρίνια.' },
      { title: 'Σύντομος ύπνος', detail: 'Μια γέφυρα προς το βράδυ· σε μάρσιπο ή καρότσι είναι μια χαρά.' },
      { title: 'Τάισμα', detail: 'Πρώτο βραδινό τάισμα, συχνά το πιο δύσκολο. Χαμηλώστε τα φώτα.' },
      { title: 'Μπάνιο ή σφουγγάρισμα', detail: 'Πλήρες μπάνιο 2–3 φορές την εβδομάδα αρκεί· ζεστό, σύντομο, προβλέψιμο.' },
      { title: 'Χαλάρωση', detail: 'Χαμηλά φώτα, χαμηλές φωνές, καθόλου οθόνες στο δωμάτιο. Ίδια σειρά κάθε βράδυ.' },
      { title: 'Τάισμα πριν τον ύπνο', detail: 'Πλήρες τάισμα για το μεγαλύτερο διάστημα που μπορεί να κάνει.' },
      { title: 'Έναρξη νυχτερινού ύπνου', detail: 'Ανάσκελα, σταθερή επίπεδη επιφάνεια, δικός του χώρος ύπνου, στο δωμάτιό σας.' },
      { title: 'Νυχτερινό τάισμα', detail: 'Τάισμα στο ξύπνημα· κρατήστε το σκοτεινό, ήσυχο και βαρετό — χωρίς παιχνίδι.' },
      { title: 'Νυχτερινό τάισμα', detail: 'Αλλαγή μόνο αν είναι λερωμένη ή πολύ βρεγμένη· αμέσως πίσω στην κούνια.' },
      { title: 'Τάισμα προς το πρωί', detail: 'Το τελευταίο νυχτερινό τάισμα. Τα νεογνά χρειάζονται 1–3 από αυτά.' },
    ],
    infant: [
    ...
    older: [
      { title: 'Ξύπνημα & γάλα', detail: 'Πρώτα γάλα στο ξύπνημα — ακόμη 4–5 ταΐσματα γάλακτος τη μέρα μαζί με τα στερεά.' },
      { title: 'Πρωινό', detail: 'Στερεά πλούσια σε σίδηρο: κρέμα, αυγό, μαλακό φρούτο. Αφήστε το να ταΐσει μόνο του και να λερωθεί.' },
      { title: 'Αλλαγή & ντύσιμο', detail: 'Περιγράψτε το, ονομάστε μέλη του σώματος, περιμένετε τον ήχο που θα σας δώσει.' },
      { title: 'Παιχνίδι στο πάτωμα', detail: 'Όλα στο πάτωμα τώρα: κύλισμα, κάθισμα, άπλωμα, ανασήκωμα στα πόδια.' },
      { title: 'Μπουσούλημα & μπρούμυτα', detail: 'Τούνελ, μαξιλάρια, ένα παιχνίδι λίγο πιο μακριά. Η κίνηση είναι όλο το πρόγραμμα.' },
      { title: 'Πρωινός υπνάκος', detail: 'Ακόμη 2–3 υπνάκοι· ο πρωινός είναι συνήθως σύντομος (~45–60 λεπτά).' },
      { title: 'Γάλα', detail: 'Γάλα στο ξύπνημα και μετά παιχνίδι — τα στερεά είναι τα γεύματα, το γάλα είναι το ρόφημα.' },
      { title: 'Βιβλία & ψέλλισμα', detail: 'Χοντρά βιβλία που πιάνει, δείξτε εικόνες, απαντήστε στο ψέλλισμα σαν να είναι λέξεις.' },
      { title: 'Μεσημεριανό', detail: 'Οικογενειακό φαγητό, μαλακά φαγητά με το χέρι, νερό σε ποτήρι. Καθόλου μέλι πριν το έτος.' },
      { title: 'Μεσημεριανός υπνάκος', detail: 'Ο μεγάλος — γύρω στη 1ώ30. Σκοτεινό δωμάτιο, ίδια ρουτίνα με τη νύχτα, στην κούνια.' },
      { title: 'Γάλα', detail: 'Απογευματινό γάλα και μετά έξοδος. Κόψτε αυτό το τάισμα όταν αρχίσει να το αρνείται.' },
      { title: 'Έξοδος & εξερεύνηση', detail: 'Πάρκο, χρόνος στο πάτωμα έξω από το καρότσι, άμμος, γρασίδι, άλλα παιδιά να παρατηρεί.' },
      { title: 'Σύντομος υπνάκος', detail: 'Ένας τρίτος σύντομος υπνάκος που συνήθως εξαφανίζεται γύρω στους 8–9 μήνες.' },
      { title: 'Σνακ', detail: 'Μικρό στερεό σνακ, καθιστό, ποτέ μέσα στο καρότσι σε κίνηση.' },
      { title: 'Ενεργό παιχνίδι', detail: 'Ανασήκωμα, βήματα κρατώντας τα έπιπλα, στοίβαγμα και γκρέμισμα.' },
      { title: 'Βραδινό', detail: 'Φάτε μαζί αν μπορείτε — μαθαίνει να τρώει βλέποντάς σας να τρώτε.' },
      { title: 'Μπάνιο & δόντια', detail: 'Βουρτσίστε τα πρώτα δόντια με ελάχιστη οδοντόκρεμα με φθόριο από τη μέρα που βγαίνουν.' },
      { title: 'Χαλάρωση', detail: 'Δύο-τρία βιβλία, χαμηλά φώτα, ίδια σειρά κάθε βράδυ.' },
      { title: 'Γάλα πριν τον ύπνο', detail: 'Το τελευταίο γάλα της μέρας — μετά δόντια, μετά κούνια· όχι γάλα στο κρεβάτι.' },
      { title: 'Νυχτερινός ύπνος', detail: 'Ανάσκελα μέχρι το έτος, δική του κούνια, ~11 ώρες. Πολλά μωρά κόβουν τα νυχτερινά ταΐσματα εδώ.' },
    ],
    oneNap: [
      { title: 'Ξύπνημα & πρωινό', detail: 'Απευθείας στο τραπέζι. Πλήρες αγελαδινό γάλα σε ποτήρι από το έτος, ~470–710 ml τη μέρα συνολικά.' },
      { title: 'Ντύσιμο & δόντια', detail: 'Αφήστε το να προσπαθήσει και ολοκληρώστε εσείς. Βούρτσισμα δύο φορές τη μέρα.' },
      { title: 'Ενεργό παιχνίδι', detail: 'Περπάτημα, σκαρφάλωμα, σπρώξιμο, μεταφορά. Στόχος 180 λεπτά κίνησης μέσα στη μέρα.' },
      { title: 'Πρωινό σνακ', detail: 'Καθιστό, με νερό δίπλα. Δύο σνακ και τρία γεύματα είναι το σχήμα της μέρας τώρα.' },
      { title: 'Έξω', detail: 'Πάρκο, κήπος, περπάτημα αντί για καρότσι — ποτέ καθισμένο πάνω από μία ώρα συνεχόμενα.' },
      { title: 'Μεσημεριανό', detail: 'Το ίδιο φαγητό με εσάς, κομμένο με ασφάλεια. Προσφέρετε χωρίς πίεση· η όρεξη έχει τεράστιες διακυμάνσεις.' },
      { title: 'Ένας υπνάκος', detail: 'Η μετάβαση από δύο σε έναν γίνεται συνήθως στους 13–18 μήνες. Στόχος 1,5–2 ώρες μετά το μεσημεριανό.' },
      { title: 'Απογευματινό σνακ', detail: 'Γάλα ή νερό και κάτι στερεό· προσοχή να μην κόβει το γάλα την όρεξη για φαγητό.' },
      { title: 'Ενεργό παιχνίδι', detail: 'Μπάλες, οχήματα, σκάλες με το χέρι σας, αρχή του συμβολικού παιχνιδιού.' },
      { title: 'Βιβλία & ήσυχο παιχνίδι', detail: 'Διαβάζετε κάθε μέρα· ονομάστε τα συναισθήματα — εδώ ξεκινούν τα ξεσπάσματα και η γλώσσα βοηθά.' },
      { title: 'Βραδινό', detail: 'Οικογενειακό τραπέζι, καθόλου οθόνες στο τραπέζι, σας βλέπει να τρώτε το ίδιο φαγητό.' },
      { title: 'Μπάνιο & δόντια', detail: 'Μπάνιο, μετά δόντια, μετά το τελευταίο ρόφημα — τίποτα γλυκό μετά το βούρτσισμα.' },
      { title: 'Χαλάρωση', detail: 'Βιβλία και τραγούδια, καθόλου οθόνες την ώρα πριν τον ύπνο. Ίδια τρία βήματα, ίδια σειρά.' },
      { title: 'Νυχτερινός ύπνος', detail: '~11–11,5 ώρες. Ο συνολικός ύπνος με τον υπνάκο να πέφτει στο εύρος 11–14 ωρών.' },
    ],
    toddler: [
      { title: 'Ξύπνημα & πρωινό', detail: 'Γύρω στις επτά. Γάλα σε ποτήρι στο τραπέζι, όχι μπιμπερό στο κρεβάτι.' },
      { title: 'Ντύσιμο & δόντια', detail: 'Δώστε δύο επιλογές για να έχει έλεγχο· το βούρτσισμα το επιβλέπετε εσείς.' },
      { title: 'Ενεργό παιχνίδι', detail: 'Τρέξιμο, πηδήματα, σκαρφάλωμα. 180 λεπτά κίνησης τη μέρα, τα 60 τουλάχιστον έντονα.' },
      { title: 'Σνακ', detail: 'Μικρό καθιστό σνακ· νερό ανάμεσα στα γεύματα αντί για χυμό.' },
      { title: 'Έξω & αδρή κινητικότητα', detail: 'Παιδική χαρά, πατίνι, μπάλα, άλλα παιδιά — από εδώ έρχονται οι κοινωνικές δεξιότητες.' },
      { title: 'Μεσημεριανό', detail: 'Οικογενειακό φαγητό, οικογενειακό τραπέζι. Μικρές μερίδες και ας ζητήσει κι άλλο.' },
      { title: 'Υπνάκος ή ήσυχη ώρα', detail: 'Περίπου ένα τρίτο των τρίχρονων έχει κόψει τον υπνάκο. Αν τον έκοψε, κρατήστε μια ώρα ήσυχης ώρας στη θέση του.' },
      { title: 'Σνακ', detail: 'Κάτι στερεό και ένα ρόφημα· θα πεινάει περισσότερο τις μέρες χωρίς υπνάκο.' },
      { title: 'Συμβολικό & ενεργό παιχνίδι', detail: 'Παιχνίδι ρόλων, τουβλάκια, ζωγραφική, διάλογος δύο ή περισσότερων εναλλαγών.' },
      { title: 'Βοήθεια & τακτοποίηση', detail: 'Ξεχώρισμα ρούχων, πότισμα φυτών, μάζεμα παιχνιδιών μαζί σας — αληθινές δουλειές, μαζί.' },
      { title: 'Βραδινό', detail: 'Φάτε μαζί, μιλήστε για τη μέρα, κρατήστε τις οθόνες μακριά από το τραπέζι.' },
      { title: 'Μπάνιο & δόντια', detail: 'Μπάνιο, δόντια, τουαλέτα. Η προβλέψιμη σειρά κάνει την ώρα του ύπνου διαπραγματεύσιμη.' },
      { title: 'Χαλάρωση', detail: 'Βιβλία, τραγούδια, καθόλου οθόνες την τελευταία ώρα. Οθόνη νωρίτερα: το πολύ 1 ώρα, μαζί σας.' },
      { title: 'Νυχτερινός ύπνος', detail: '~11 ώρες στο κρεβάτι. Συνολικός ύπνος 10–13 ώρες σε αυτή την ηλικία, με τον υπνάκο μέσα αν τον κρατά.' },
    ],
    },
    sourcesLabel:
