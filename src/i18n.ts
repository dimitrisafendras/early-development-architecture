...
const en = {
  ...
  schedule: {
    ...
    activityOk: 'This day plans {planned} min of {kind} — the guidance at this age is {target} min.',
    activityShort: 'This day plans {planned} min of {kind}; the guidance at this age is {target} min.',
...
const el: Messages = {
  ...
  schedule: {
    ...
    activityOk: 'Η μέρα προβλέπει {planned} λεπτά {kind} — η σύσταση για αυτή την ηλικία είναι {target} λεπτά.',
    activityShort: 'Η μέρα προβλέπει {planned} λεπτά {kind}· η σύσταση για αυτή την ηλικία είναι {target} λεπτά.',
